...
## Docs live in the knowledge library

Full documentation is an Obsidian vault at **`/home/jonasz/sportking/library`**.
**Pull from it — don't preload.** Start at `/home/jonasz/sportking/library/MAP.md`; open only what the
task needs. Scan every note's purpose: `grep -rh "^summary:" /home/jonasz/sportking/library --include=*.md`.
